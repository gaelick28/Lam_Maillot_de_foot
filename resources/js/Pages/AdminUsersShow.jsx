    ...
    <AdminLayout>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 overflow-hidden">
          <Link href="/admin/users" className="hover:text-blue-600 truncate">Utilisateurs</Link>
          <span>›</span>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
          <div className="min-w-0">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 truncate">{user.username}</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Statistiques</h3>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-600 text-sm sm:text-base">Commandes :</span>
                <span className="font-bold text-gray-900">{ordersCount}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 text-sm sm:text-base">Total dépensé :</span>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Compte</h3>
            <div className="space-y-3">
              <div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-4 sm:p-6 border-b flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Modifier les informations</h2>
            <button
              onClick={() => setShowEditForm(!showEditForm)}
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors w-full sm:w-auto ${showEditForm
          ...
          {showEditForm && (
            <form onSubmit={updateUser} className="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-4 sm:p-6 border-b">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Adresses</h2>
          </div>
          ...
          <div className="border-b border-gray-200 overflow-x-auto">
            <div className="flex min-w-max">
              <button
                ...
                className={`px-4 sm:px-6 py-3 font-medium transition-colors text-sm sm:text-base whitespace-nowrap ${activeTab === 'shipping'
              ...
              <button
                ...
                className={`px-4 sm:px-6 py-3 font-medium transition-colors text-sm sm:text-base whitespace-nowrap ${activeTab === 'billing'
                  ? 'border-b-2 border-blue-600 text-blue-600'
                  : 'text-gray-600 hover:text-gray-800'
                  }`}
              >
                    ...
                    .map((address) => (
                      <div key={address.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                        <div className="flex flex-col sm:flex-row justify-between items-start gap-2 mb-2">
                          ...
                          {address.is_default && (
                            <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-medium rounded shrink-0">
                              Par défaut
                            </span>
                          )}
                        </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-[640px]">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">N° Commande</th>
                  ...
                  {user.orders.map((order) => (
                    <tr key={order.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 sm:px-6 py-4 text-sm">
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${order.order_status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
